#!/usr/bin/env bash
# Install the latest ai-project-template binary from GitHub Releases.
# Usage: curl -fsSL https://raw.githubusercontent.com/yigegongjiang/ai-project-template/main/cli/scripts/install.sh | bash

set -euo pipefail

REPO="yigegongjiang/ai-project-template"
